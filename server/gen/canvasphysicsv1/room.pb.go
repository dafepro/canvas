...
const (
	...
	ItemMutationRejectCode_ITEM_MUTATION_REJECT_APPLICATION_POLICY               ItemMutationRejectCode = 15
	ItemMutationRejectCode_ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE          ItemMutationRejectCode = 16
	ItemMutationRejectCode_ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT ItemMutationRejectCode = 17
)
...
var (
	ItemMutationRejectCode_name = map[int32]string{
		...
		15: "ITEM_MUTATION_REJECT_APPLICATION_POLICY",
		16: "ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE",
		17: "ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT",
	}
	ItemMutationRejectCode_value = map[string]int32{
		...
		"ITEM_MUTATION_REJECT_APPLICATION_POLICY":               15,
		"ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE":          16,
		"ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT": 17,
	}
)
...
type ItemMutation struct {
	...
	// Opaque, bounded evidence consumed only by the host application authorizer.
	// Canvas never includes it in snapshots or mutation results.
	AuthorizationEvidence []byte `protobuf:"bytes,16,opt,name=authorization_evidence,json=authorizationEvidence,proto3" json:"authorization_evidence,omitempty"`
	// Opaque application identity used by trusted server-side reconciliation.
	ApplicationCorrelationId string `protobuf:"bytes,17,opt,name=application_correlation_id,json=applicationCorrelationId,proto3" json:"application_correlation_id,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ItemMutation) GetAuthorizationEvidence() []byte {
	if x != nil {
...
func (x *ItemMutation) GetApplicationCorrelationId() string {
	if x != nil {
		return x.ApplicationCorrelationId
	}
	return ""
}
...
const file_packages_protocol_proto_room_proto_rawDesc = "" +
	...
	"\x12collisions_enabled\x18\x0f \x01(\bR\x11collisionsEnabled\x125\n" +
	"\x16authorization_evidence\x18\x10 \x01(\fR\x15authorizationEvidence\x12<\n" +
	"\x1aapplication_correlation_id\x18\x11 \x01(\tR\x18applicationCorrelationId\"\x85\x04\n" +
	...
	"\x13ITEM_MUTATION_SCALE\x10\b*\xf2\x05\n" +
	...
	"\x1dITEM_MUTATION_REJECT_INTERNAL\x10\x0e\x12+\n" +
	"'ITEM_MUTATION_REJECT_APPLICATION_POLICY\x10\x0f\x120\n" +
	",ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE\x10\x10\x129\n" +
	"5ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT\x10\x11*\xf5\x01\n" +
