...
export function itemMutationRejectCodeFromJSON(object: any): ItemMutationRejectCode {
  switch (object) {
    ...
    case 15:
    case "ITEM_MUTATION_REJECT_APPLICATION_POLICY":
      return ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_POLICY;
    case 16:
    case "ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE":
      return ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE;
    case 17:
    case "ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT":
      return ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function itemMutationRejectCodeToJSON(object: ItemMutationRejectCode): string {
  switch (object) {
    ...
    case ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_POLICY:
      return "ITEM_MUTATION_REJECT_APPLICATION_POLICY";
    case ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE:
      return "ITEM_MUTATION_REJECT_APPLICATION_UNAVAILABLE";
    case ItemMutationRejectCode.ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT:
      return "ITEM_MUTATION_REJECT_APPLICATION_CORRELATION_CONFLICT";
...
export interface ItemMutation {
   ...
   */
  authorizationEvidence: Uint8Array;
...
function createBaseItemMutation(): ItemMutation {
  return {
    ...
    authorizationEvidence: new Uint8Array(0),
...
export const ItemMutation: MessageFns<ItemMutation> = {
  encode(message: ItemMutation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.authorizationEvidence.length !== 0) {
      writer.uint32(130).bytes(message.authorizationEvidence);
    }
    if (message.applicationCorrelationId !== "") {
      writer.uint32(138).string(message.applicationCorrelationId);
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 16: {
            ...
            message.authorizationEvidence = reader.bytes();
            continue;
          }
          case 17: {
            if (tag !== 138) {
            ...
            message.applicationCorrelationId = reader.string();
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ItemMutation {
    return {
      ...
      collisionsEnabled: isSet(object.collisionsEnabled)
        ...
        : false,
      authorizationEvidence: isSet(object.authorizationEvidence)
        ? bytesFromBase64(object.authorizationEvidence)
        : isSet(object.authorization_evidence)
        ? bytesFromBase64(object.authorization_evidence)
        : new Uint8Array(0),
      applicationCorrelationId: isSet(object.applicationCorrelationId)
        ? globalThis.String(object.applicationCorrelationId)
        : isSet(object.application_correlation_id)
        ? globalThis.String(object.application_correlation_id)
        : "",
    };
  },
  ...
  toJSON(message: ItemMutation): unknown {
    ...
    if (message.authorizationEvidence.length !== 0) {
      obj.authorizationEvidence = base64FromBytes(message.authorizationEvidence);
    }
    if (message.applicationCorrelationId !== "") {
      obj.applicationCorrelationId = message.applicationCorrelationId;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ItemMutation>, I>>(object: I): ItemMutation {
    ...
    message.authorizationEvidence = object.authorizationEvidence ?? new Uint8Array(0);
    message.applicationCorrelationId = object.applicationCorrelationId ?? "";
    return message;
  },
};
