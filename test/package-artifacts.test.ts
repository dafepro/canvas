  ...
  it("packs built entry points and installs them outside the workspace", () => {
    ...
    writeFileSync(
      ...
      [
        ...
        'import { runRoomTransportConformance, runSimulationWorkerConformance } from "@canvas-physics/client/testing";',
        'import { installSimulationWorker } from "@canvas-physics/client/worker-runtime";',
        "if (!BehaviorRegistry || !runBehaviorConformance || !PROTOCOL_VERSION || !SimulationDriver || !runRoomTransportConformance || !runSimulationWorkerConformance || !installSimulationWorker) process.exit(1);",
